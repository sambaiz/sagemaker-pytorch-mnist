...
def train(args):
    ...
    train_loader = _make_train_loader(args.batch_size, args.data_dir,
                                      is_distributed, **kwargs)
    test_loader = _make_test_loader(args.test_batch_size, args.data_dir,
                                    **kwargs)

    for epoch in range(1, args.epochs + 1):
        md.train(model, train_loader, deivce, is_distributed, args.lr,
                 args.momentum)
        md.test(model, test_loader, device)
